      ...
      <div align="center">
        ...
        <div class="row justify-content-center">
          <div class="col-md-3 mb-2">
            ...
            <input v-model="client.firstName" type="text" class="form-control" id="firstName" placeholder="Input your First Name" value="" required="">
          </div>
          <div class="col-md-3 mb-2">
            <label for="lastName">Last Name</label>
            <input v-model="client.lastName" type="text" class="form-control" id="lastName" placeholder="Input your Last Name" value="" required="">
          </div>

        </div>
        <div class="col-md-6 text-center">
          <button v-on:click="createClient()" id="btn" class="btn btn-primary btn-lg btn-block" type="submit">Create client</button>
        </div>
      </div>
    </section>
