      ...
      <div align="center">
        ...
        <div class="row justify-content-center">
          ...
          <div class="col-md-3 mb-2">
            ...
            <input v-model="acc.money" type="number" class="form-control" id="money" placeholder="Input amount to deposite" value="" required="">
          </div>

        </div>
        <div class="col-md-6 text-center">
          <button v-on:click="deposit()" id="btn" class="btn btn-primary btn-lg btn-block" type="submit">Deposit</button>
        </div>
      </div>
    </section>
