      ...
      <div align="center">
        ...
        <div class="row justify-content-center">
          <div class="col-md-2 mb-2">
            ...
            <input v-model="acc.fromAccount" type="text" class="form-control" id="fromAccount" placeholder="Transfer from Account" value="" required="">
          </div>
          <div class="col-md-2 mb-2">
            <label for="toAccount">To Account</label>
            <input v-model="acc.toAccount" type="text" class="form-control" id="toAccount" placeholder="Transfer to Account" value="" required="">
          </div>
          <div class="col-md-2 mb-2">
            <label for="money">Money</label>
            <input v-model="acc.money" type="number" class="form-control" id="money" placeholder="Input amount to transfer" value="" required="">
          </div>

        </div>
        <div class="col-md-6 text-center">
          <button v-on:click="transfer()" id="btn" class="btn btn-primary btn-lg btn-block" type="submit">Transfer</button>
        </div>
      </div>
    </section>
...
let transferFunc = function() {
  let url = "http://localhost:8080/bank/account/transfer";
